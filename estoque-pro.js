...
(function () {
  ...
  window.editarEstoque = function (i) {
    ...
    if (m.etipo === "Saída") {
      ...
      document.getElementById("squantidade").value = m.equantidade == null ? "" : m.equantidade;
      ...
      document.getElementById("eestoqueminimo").value = m.eestoqueminimo == null ? "" : m.eestoqueminimo;
